...
public class Mukadimah extends CanvasActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		subHeaderText.setText("Mukadimah");
	...
	public SparseArray<SimpleExpandableDataModel> createData() {
		...
		data = new Gson().fromJson(FileUtil.getReaderFromRawFile(this, R.raw.mukadimah), new TypeToken<List<SimpleItemDescriptionModel>>(){}.getType());
