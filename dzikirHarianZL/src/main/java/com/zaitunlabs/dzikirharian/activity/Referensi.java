...
public class  Referensi extends CanvasActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		subHeaderText.setText("Referensi");
	...
	public SparseArray<SimpleExpandableDataModel> createData() {
	    ...
	    data = new Gson().fromJson(FileUtil.getReaderFromRawFile(this, R.raw.referensi), new TypeToken<List<SimpleItemDescriptionModel>>(){}.getType());
